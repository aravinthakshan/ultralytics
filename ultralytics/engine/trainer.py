...
from ultralytics.engine.soap_optimizier import SOAP # check if this is being imported
import numpy as np
import torch
...
class BaseTrainer:
    ...
    def build_optimizer(self, model, name="auto", lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        optimizers = {"Adam", "Adamax", "AdamW", "NAdam", "RAdam", "RMSProp", "SGD", "auto","SOAP"}
